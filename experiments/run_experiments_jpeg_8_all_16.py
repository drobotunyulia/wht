...
from wht_jpeg_8_all_16 import encode_miniwht, decode_miniwht
...
def run_single_method(
    ...
    """
    Запускает один метод кодирования/декодирования и возвращает строку результата.
    method_type:
        "dct" или "wht"
    """
    ...
    if method_type == "dct":
        ...
        raise ValueError(f"Неизвестный method_type: {method_type}")
...
def run_experiments(data_folder="data", output_file="results.csv"):
    ...
    methods = [
        {
            "method_name": "MiniJPEG_DCT",
            "method_type": "dct",
            "block_size": 8,
            "matrix_class": "dct"
        },
        {
            "method_name": "MiniJPEG_WHT_8_sylvester",
            "method_type": "wht",
            "block_size": 8,
        ...
        {
            "method_name": "MiniJPEG_WHT_16_class2",
            "method_type": "wht",
            "block_size": 16,
            "matrix_class": "class2"
        },
        {
            "method_name": "MiniJPEG_WHT_16_class3",
            "method_type": "wht",
            "block_size": 16,
            "matrix_class": "class3"
        },
        {
            "method_name": "MiniJPEG_WHT_16_class4",
            "method_type": "wht",
            "block_size": 16,
            "matrix_class": "class4"
        },
        {
            "method_name": "MiniJPEG_WHT_16_class5",
            "method_type": "wht",
            "block_size": 16,
            "matrix_class": "class5"
        },
...
if __name__ == "__main__":
    run_experiments("data", "results_all_classes.csv")